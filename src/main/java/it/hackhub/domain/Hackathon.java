...
public class Hackathon {
    ...
    public boolean isIscrizioniAperte() {
        return LocalDateTime.now().isBefore(scadenzaIscrizioni) && stato != HackathonStatus.CONCLUSO;
    }

    public boolean isInCorso() {
        LocalDateTime now = LocalDateTime.now();
        return now.isAfter(dataInizio) && now.isBefore(dataFine) && stato != HackathonStatus.CONCLUSO;
    }
