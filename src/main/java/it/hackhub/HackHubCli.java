...
public class HackHubCli implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        Hackathon hackathon = new Hackathon(1L, "HackHub Demo", "Regolamento base",
                LocalDateTime.now().plusDays(5),
                LocalDateTime.now().minusDays(1),
                LocalDateTime.now().plusDays(2),
                4, organizzatore, giudice);
        ...
        System.out.println("HackHub - prima iterazione avviata con dati dimostrativi.");
    }
}
