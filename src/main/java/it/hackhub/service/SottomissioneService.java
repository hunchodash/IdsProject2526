...
public class SottomissioneService {
    ...
    public Sottomissione inviaSottomissione(Long teamId, Long hackathonId, String contenuto) {
        ...
        if (sottomissioneRepository.findByHackathonIdAndTeamId(hackathonId, teamId).isPresent()) {
            throw new IllegalStateException("Il team ha già inviato una sottomissione per questo hackathon: usare l'aggiornamento");
        }
    ...
    public Sottomissione aggiornaSottomissione(Long sottomissioneId, String nuovoContenuto) {
        ...
        if (!sottomissione.getValutazioni().isEmpty()) {
            throw new IllegalStateException("Aggiornamento non possibile: la sottomissione è già stata valutata");
        }
